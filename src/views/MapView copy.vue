<template>
  ...
  <LegendBox></LegendBox>
  <el-dialog v-model="isopen" title="详细信息" width="430px" draggable top="210px" modal=false>
    ...
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="addStation(curveData.id)">
          添加
        </el-button>
      </span>
    </template>
...
// 添加台站
const addStation = (curveId: string) => {
  store.commit('setStationsTOBePositioned', curveId)
  isopen.value = false
}
